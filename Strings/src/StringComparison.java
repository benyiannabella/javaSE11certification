...
public class StringComparison {
    public static void main(String[] args) {
        ...
        //  == operand
        TestEqualsOperand(stringHello2, secondString);

        //  public boolean equals(Object anObject)
        TestEqualsMethod(stringHello2, secondObject);

        // ---- public boolean equalsIgnoreCase?(String anotherString)
        TestEqualsIgnoreCaseMethod(stringHello2, secondString);

        // ---- public boolean contentEquals?(CharSequence cs)
        TestContentEqualsMethod(stringHello2, secondSequence);

        // ---- public int compareTo?(String anotherString)
        TestCompareToMethod(stringHello2, secondString);

        // ----- public int compareToIgnoreCase?(String str)
        TestCompareToIgnoreCaseMethod(stringHello2, secondString);
